...
<html lang="en">
  <head>
    ...
    <title>IUTIRLA - Instituto Universitario Rodolfo Loero Arismendi</title>
  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			<h1 class="logo"><a href="index.html#home">IUTIRLA</a></h1>
	...
	<div id="headerwrap">
		<div class="container">
			<br>
			<h1>IUTIRLA</h1>
			<h2>Instituto Universitario Rodolfo Loero Arismendi</h2>
			<div class="row">
				<br>
				<br>
				<br>
